  ...
  return (
    <div className={cn('flex items-center gap-1.5 text-sm', className)}>
      <span className="shrink-0 size-3 relative flex items-center justify-center">
        <span className="absolute inset-0 bg-lime-500/25  rounded-full" />
        <span className="absolute inset-0 bg-lime-500/25 rounded-full animate-ping" />
        <span className="size-1.5 shrink-0 bg-lime-500 rounded-full" />
      </span>
      {label}
    </div>
  )
