...
export const Testimonial: FC<{content: Content}> = ({content}) => {
  return (
    <>
      <Divider />
      <Section className="relative overflow-hidden pt-20 flex flex-col items-center gap-6">
        ...
        <div className="text-3xl font-display italic leading-tight text-indigo-500 dark:text-indigo-400 relative">{`"${content.quote}"`}</div>
