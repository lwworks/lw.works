...
export const DigitalDealerHeroSection = ({ content }: { content: DigitalDealerHeroSectionContent }) => {
  return (
    <Section bottomGradients="rose-orange">
      <Image src="/images/digital-dealer/renault-r5-website.png" alt={content.imageAlt} width={1604} height={1025} className="absolute bottom-0 -right-21 max-h-76 w-auto opacity-75" />
