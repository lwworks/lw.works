...
export const ServicesSection = () => {
  return (
    <Section verticalPadding="none" horizontalPadding="none">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-black/10 dark:divide-white/10 border-b border-black/10 dark:border-white/10">
        <div className="p-4 py-8 sm:px-8 lg:p-16 lg:py-8 overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-black/10 dark:divide-white/10">
        <div className="p-4 py-8 sm:px-8 lg:p-16 lg:pt-8 overflow-hidden">
        ...
        <div className="p-4 pt-8 pb-12 sm:px-8 lg:p-16 lg:pt-8 overflow-hidden">
