  ...
  return (
    <Section background="paint-1">
      ...
      <Heading as="h1" className="text-3xl sm:text-4xl lg:text-5xl">
        <Image src="/images/logos/bni-black.svg" alt="BNI Logo" width={167} height={64} className="inline-block dark:hidden h-5.5 sm:h-6.5 lg:h-8 w-auto ml-1 mr-2 sm:mr-3 -mt-1.5 sm:-mt-2" />
        <Image src="/images/logos/bni-white.svg" alt="BNI Logo" width={167} height={64} className="hidden dark:inline-block h-5.5 sm:h-6.5 lg:h-8 w-auto ml-1 mr-2 sm:mr-3 -mt-1.5 sm:-mt-2" />
