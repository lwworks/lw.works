...
export const CalendarSolidIcon: FC<{className: string}> = ({className}) => {
  return (
    <svg viewBox="0 0 20 20" className={`fill-current ${className}`} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
