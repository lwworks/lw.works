...
import { DigitalDealerHeroSection } from '@/components/sections/digital-dealer/hero'
import { TestimonialSection } from '@/components/sections/testimonial'
import { CalloutSection } from '../sections/callout'
import { DigitalDealerContactSection } from '../sections/digital-dealer/contact'
import { DigitalDealerPricingSection } from '../sections/digital-dealer/pricing'
...
const content = {
  ...
  contact: {
    ...
    privacy: <>Ich habe die <Link href={"/privacy" as string} target="_blank" className="text-indigo-600 dark:text-indigo-400 underline hover:text-indigo-800 dark:hover:text-indigo-500">Datenschutzerklärung</Link> gelesen und bin mit der Verarbeitung meiner Daten einverstanden.</>,
...
export const digitalDealerMetadata = content.metadata

export const DigitalDealerPage = () => {
  return (
